...
class Engine:
    ...
    def train(self,epsilon, limit = 1000, batch_size = 1000, trials = 10, fileName = "train_metrics.csv"):
        ...
        Writes Training metrics to fileName
        ...
        ----------
            ...
            fileName: file to write training metrics
        """
        # Initialize Metrics
        with open(fileName,"w") as file: file.write("Epoch,Reward,Loss\n")
        lim = limit
        ...
        for t in range(trials):
            ...
            with open(fileName,"a") as file: file.write(f"{t},{np.sum(rewards)/(np.sum(dones)+1)},{loss}\n")

    def train_vec(self, batch_size, trials, epsilon, fileName = "train_vec_metrics.csv"):
        """
        Train Neural Net on Random starting states to maximize exploration
        Writes Training metrics to fileName
    ...
    def train_dynamic(self, trials, fileName = "train_dynamic_metrics.csv"):
        """
        Train Neural Net on all possible discrete states
        Writes Training metrics to fileName
